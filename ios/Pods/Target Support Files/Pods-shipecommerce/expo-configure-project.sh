...
with_node \
  ...
  --target "/Users/ajavaheri/Documents/shiplifiermobileApp/shipping-ecommerce/ios/Pods/Target Support Files/Pods-shipecommerce/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-application" "expo-asset" "expo-constants" "expo-device" "expo-file-system" "expo-font" "expo-keep-awake"
